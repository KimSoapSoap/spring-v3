package green.mtcoding.springv3.core.error;

import green.mtcoding.springv3.core.error.ex.*;
import green.mtcoding.springv3.core.util.Resp;
import green.mtcoding.springv3.core.util.Script;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.ExceptionHandler;
import org.springframework.web.bind.annotation.RestControllerAdvice;

//일반적으로 뷰를 요청받았을 때 쓰는 핸들러를 만들고
//Api요청(Ajax요청) 받았을 때 쓰는 핸들러 이렇게 2개 만들어 준다.
